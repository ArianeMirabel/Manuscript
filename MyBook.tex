...
\usepackage[style=authoryear-ibid,backend=bibtex,citestyle=authoryear,pageref=true,isbn=false,backref=true,giveninits=true,uniquename=init,maxcitenames=2,maxbibnames=150,sorting=nyt,sortcites=false]{biblatex}
...
\njudge{7}
\makesomeone{judge}{1}{PrÃ©nom NomJury1}{Professeur d'UniversitÃ©}{Membre du Jury}
\makesomeone{judge}{2}{PrÃ©nom NomJury2}{Professeur d'UniversitÃ©}{Membre du Jury}
\makesomeone{judge}{3}{PrÃ©nom NomJury3}{Professeur d'UniversitÃ©}{Membre du Jury}
\makesomeone{judge}{4}{PrÃ©nom NomJury4}{Professeur d'UniversitÃ©}{Membre du Jury}
\makesomeone{judge}{5}{PrÃ©nom NomJury5}{Professeur d'UniversitÃ©}{Membre du Jury}
\makesomeone{judge}{6}{PrÃ©nom NomJury6}{Professeur d'UniversitÃ©}{Membre du Jury}
\makesomeone{judge}{7}{PrÃ©nom NomJury7}{Professeur d'UniversitÃ©}{Membre du Jury}
...
forestières, qui reflète de plus celle des autres groupes floristiques
ou faunistiques \autocite{Guitet2017}. Individuellement, les espèces
constituent le patrimoine naturel global et, selon leur
charactéristiques biologiques, peuvent avoir un rôle clé dans leur
communauté, comme c'est le cas pour les espèces \emph{clé de voûte}
\autocites{Jones1994}{Power1996}{Gardner2007}. Dans l'ensemble la
...
\section{L'avenir de la biodiversité: dynamique des communautés et
règles
d'assemblage}\label{lavenir-de-la-biodiversite-dynamique-des-communautes-et-regles-dassemblage}
...
d'une part des processus déterministes sélectionnant les espèces selon
leurs aptitudes dans l'environnement biotique et abiotique considéré
\autocite{Molino2001}, et d'autre part les processus stochastiques de la
théorie neutre relevant des contraintes historiques et de limitation de
dispersion ou de croissance \autocite{Hubbell2001}.
...
\subsection{Motalité et recrutement, moteurs de la dynamique des
communautés}\label{motalite-et-recrutement-moteurs-de-la-dynamique-des-communautes}
...
\selectlanguage{french}
\item[Mots clés :]
Biodiversité, Forêts Néotropicales, Perturbation, Ecologie des Communautés, Trajectoires dynamiques, Résilience.
~\\
