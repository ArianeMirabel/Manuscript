...
\usepackage[style=authoryear,backend=bibtex,citestyle=authoryear,isbn=false,backref=true,pageref=true,giveninits=true,uniquename=init,maxcitenames=2,maxbibnames=150,sorting=nyt,sortcites=false]{biblatex}
