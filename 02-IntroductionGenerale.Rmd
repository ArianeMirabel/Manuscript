...
Une autre approche axée sur la multifonctionnalité des forêts réhabilite la possibilité d'un équilibre durable entre production et conservation.
L'exploitation forestière peut intégrer cette dernère approche, et permettre à la fois le maintien du fonctionnement des forêts et un développement économique et social, sous réserve d'une gestion adéquate.
...
Outre la composition en espèce, l'étude de la biodiversité est l'étude de la diversité des communautés basée sur la distribution d'abondance des espèces.
