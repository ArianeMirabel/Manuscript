...
Parmi les espèces tropicales inventoriées en milieu tropical, un grand nombre ne correspond qu'à l'observation d'un unique individu [@Feeley2011], et la précision des inventaires reste fortement contrainte par le coût financier et la main d'œuvre qu'ils représentent.
...
Handling the conservation and management of tree diversity requires setting sensible protection areas and sustainable forest management calibrated according to diversity patterns in space and time and their determinants [@Gibson2011;@Sist2015].
...
These methods efficiently translated biodiversity patterns at regional scales and along wide ecological gradients [@Higgins2004;@Pos2014].
...
Second, as exhaustive inventories, they allow some post-process based on vernacular/botanical names association and allow the building of reliable diversity estimators [@TerSteege2006;@Feldpausch2006;@Rejou-Mechain2008].
