...
Malgré leur importance les forêts restent extrêmement menacées dans le contexte actuel de changements globaux.

## Les forêts tropicales, au coeur des enjeux actuels

Par "forêt" ou "ecosystème forestier" on entend les assemblages de plantes, animaux et microorganismes avec leur environnement qui définissent une unité fonctionnelle, dont les arbres sont les composants essentiels [@FRA2000]. 
Ces écosystèmes représentent de forts enjeux de conservation, en restant les régions les moins anthropisées et en accueillant la diversité animale et végétale et les taux d'endémisme les plus importants du globe [@Myers2000; @Mittermeier2003].

Les forêts entretiennent les cycles de l'eau et des nutriments (azote, phosphore, etc), et régulent la fertilité des sols et le climat local [@Malhi2008; @Isbell2017].
A l'échelle globale elles régulent également les émission de gaz à effet de serre (*GES*), en tant que puits de 1.1 ± 0.8 PgC.yr^–1^ de carbone qui compensent les émissions de GES, et en tant que source potentielle via la libération du carbone stocké dans leur biomasse lorsqu'e'elles dégradées [@Pan2011; @Roy2017].
...
Enfin, l'exploitation forestière correspond à de forts enjeux économiques: elle représente ~ 1% du PIB mondial, une part importante de l'emploi et l'une des principales sources d'énergie en 2011 [@CBDdiversity2011; @FAO2014].


Indispensables et irremplaçables, les forêts sont malgré tout dégradées et disparaissent à une vitesse croissante: entre 2013 et 2015 par exemple leur surface globale a diminué de 3% [@FAO2009].
Elles sont soumises à de fortes pressions anthropiques allant des changements d’usage des terres, tels que le déboisement pour l'élevage ou l'agriculture, l'exploitation du bois légale ou illégale, la chasse ou l'introduction d’espèces invasives.
...
Ces pressions diverses ont conduit à une prise de conscience globale entérinée par la conférence des nations unies sur l'environnement et le développement à Rio en 1992.
Depuis, de nombreuses politiques de surveillance, de conservation de la biodiversité et de préservation du fonctionnement des forêts ont été mises en place mais les menaces persistent, voire s'accroissent malgré tout [@Summit1992; @Schlaepfer2000; @Dirzo2003a; @Morales-Hidalgo2015].

Les forêts tropicales en particulier, aux enjeux économiques et de préservation primordiaux au niveau mondial, sont de plus en plus menacées [@Dirzo2003a; @Hansen2013]. 
Les bassins forestiers tropicaux représentent 19.6 million de km² et accueillent la diversité biologique la plus élevée au monde sont les plus grandes forêts anciennes n'ayant pas connu de forte perturbation anthropique [@Gentry1988; @FAO2011].
Historiquement peu peuplées, ces régions connaissent néanmoins une croissance démographique moyenne de près de 1,4% par an entraînant des pressions anthropiques croissantes qui rendent leur devenir incertain [@Asner2009].
Les diverses pressions qui s'exercent sur les forêts ont déjà provoqué la disparition de nombre d'espèces, engendrant une "érosion" de la biodiversité qui participe à ce que l'on qualifie déjà de sixième extinction de l’ère moderne [@Vitousek1997; @Cardinale2012].

 
La conservation des forêts tropicales est aujourd'hui un enjeu majeur, mais la seule désignation d'aires protégées ne suffit pas à maintenir leur immense biodiversité et de leur fonctionnement complexe [@Sist2015].
Dans ce contexte, l'exploitation forestière est centrale car elle peut assurer des profits économiques et sociaux tout en préservant la biodiversité et le fonctionnement des écosystèmes comme dans le cas de l'exploitation sélective.
L'exploitation sélective correspond à l'exploitation de quelques espèces cibles dont les individus à exploiter sont désignés à l'avance sans que le reste du peuplement ne soit impacté.
L'exploitation sélective, bien moins préjudiciable au fonctionnement de l'écosystème que de nombreuses autres activités anthropiques, est appliquée aujourd'hui à environ 20% de la surface des forêts tropicales et représente 12% de la production mondiale de bois d'oeuvre [@Martin2015].
Bien qu'ayant un potentiel important pour la préservation des forêts l'exploitation sélecive peut avoir des conséquences significatives et entraîner par exemple des changements dans la composition et la diversité des communautés, voire l'extinction locale d'espèces [@Gibson2011].
Les pratiques de gestion forestière sont aujourd'hui principalement établies en vue de la reconstitution du stock de bois d'oeuvre, mais pourraient être calibrées selon la restauration de la diversité en espèces ou du fonctionnement de l'écosystème, pour intégrer des enjeux de préservation à la gestion forestière.
La sylviculture est régulée par la limitation de l'exploitation à un diamètre minimum de coupe et par le temps de récupération entre deux coupes, de 30 ou 40 ans généralement [@Sist2015].
Intégrer la conservation aux pratiques sylvicoles nécessite dans un premier temps de déterminer l'impact des modes de gestion sur la diversité et la composition des forêts tropicales.

## Diversité et assemblage des communautés

Les arbres sont les éléments essentiels des écosystèmes forestiers.
Leur diversité reflète celle des autres groupes floristiques et faunistiques et détermine largement le fonctionnement des écosystèmes forestiers [@Guitet2017].
Individuellement, les espèces ont une valeur intrinsèque pour le patrimoine naturel global et peuvent avoir un rôle clé au sein les communautés selon leurs caractéristiques biologiques, comme c'est le cas pour les espèces *clé de voûte* [@Jones1994; @Power1996; @Gardner2007].
A l'échelle de la communauté, la diversité et la composition de l'assemblage d'espèces qui détermine les interactions entre les individus et avec l'environnement est directement liée aux processus écosystémiques et à la productivité de la communauté [@Begon2006].
La diversité des communautés détermine de plus la stabilité et la résilience des écosystèmes, une diversité élevée palliant l'impact des maladies, des espèces invasives et des variations environnementales [@Elmqvist2003].

L'érosion de la biodiversité impacte nécessairement le fonctionnement des communautés mais le détail de la réponse des communautés et des conséquences de cette érosion reste mal connu.
Comprendre et anticiper l'avenir des forêts tropical dans le contexte de changements actuel nécessite d'expliciter la réponse des forêts aux perturbations et d'identifier les processus écologiques sous-jacents. 

### Les règles d'assemblage des communautés

Expliciter et comprendre la réponse des forêts aux perturbations passe par la compréhension des processus qui déterminent l'assemblage des communautés d'arbres et la coexistence des espèces.
Plusieurs hypothèses sur les processus d'assemblage des communautés sont débattues aujourd'hui, notamment le rôle des processus stochastiques et déterministes.
Les processus déterministes sélectionnent les espèces de la communauté selon leurs performance, définie par leurs caractéristiques biologiques, étant donné l'environnement biotique et abiotique de la communauté [@Molino2001].
...
Ce débat quant au rôle des processus stochastiques et déterministes régissant l'assemblage des communautés est matérialisé dans le cas des forêts tropicales par la controverse sur la théorie des perturbations intermédiaires (*Intermediaite Disturbance Hypothesis*, *IDH* en anglais).
Cette théorie suppose la prépondérance de processus déterministes d'exclusion compétitive et de filtrage des espèces, prédit que jusqu'à un certain seuil la diversité est d'autant plus élevée que le milieu est perturbé [@Molino2001].
Un tel régime de perturbations ferait varier les conditions biotiques (interactions entre individus) et abiotiques (ensoleillement, température, flux d'eau et de matière) de l'environnment sans engendrer de modification drastique.
...
A l'inverse la théorie neutre suppose que les espèces sont équivalentes et que leur abondance ne dépend pas de leurs caractéritiques biologiques mais plutôt de processus aléatoires de dispersion, de croissance et de survie qui résultent en un assemblage stochastique des communautés [@Hubbell2001].
...
Il est vraisemblable que les communautés résultent de combinaisons variables dans l'espace et le temps de processus déterministes et stochastiques, valables à différents niveaux.
La question se porte alors sur l'importance relative de ces processus et sur les facteurs qui influencent leur combinaison [@Chave2004]. 

### Succession, mortalité et recrutement: supports de la trajectoire des forêts

La réponse des communautés aux perturbations est reconnue pour suivre dans le temps une succession régie après la perturbation par l'évolution des conditions environnementales biotique et abiotique.
Les modèles de succession identifiés correspondent dans un premier temps au recrutement d'espèces pionnières, meilleures acquisitrices des ressources importantes rendues disponibles après perturbation.
Dans un deuxième temps, suivant la croissance des premiers recrutés, la disponibilité en ressourcesdiminue, la compétition augmente et exclut finalement la disparition des espèces les moins compétitrices. 
Les pionnières installées en premier lieu, sénescentes ou exclues car moins compétitives, sont alors remplacées par les espèces de succession tardive, ayant en forêt tropicale une croissance lente mais une longue durée de vie.
Cette succession aboutit ainsi de façon déterministe à la restauration d'une communauté de succession tardive.
...
En particulier, la succession forestière après perturbation repose sur l'évolution des processus écologique déterminant le recrutement et la mortalité dans la communauté. 
Décomposer la réponse des communautés selon ces processus démographiques affine ainsi la compréhension des processus déterminant la réponse des communautés à la perturbation.

La mort d'un arbre provoque une trouée dans la canopée qui modifie l'environnement abiotique (ensoleillement, flux d'eau, de nutriments et de matière) et biotique (interactions entre individus), et impacte la croissance et l'établissement des arbres environnants.
La mortalité est un moteur essentiel de la dynamique des communautés et de sa variabilité dans l'espace et le temps en tant que processus aléatoire [@Denslow1998;@Sheil2003;@Goulamoussene2017;@Otani2018].
