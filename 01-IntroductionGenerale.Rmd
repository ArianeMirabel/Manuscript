...
## Composition et dissimilarity entre communautés

De nombreuses mesures permettent d'estimer ce turnover, qui prennent en compte ou non l'abondance des espèces [@Podani2013a].
Nous avons choisis ici de mesurer le taux de remplacement d'abondance, ou similarité de Bary-Curtis, qui représente dans quelle mesure une communauté est le sous-ensemble d'une plus grande. 
