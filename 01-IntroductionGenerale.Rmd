...
Plusieurs hypothèses sont débattues aujourd'hui, invoquant des processus déterministes d'une part sélectionnant les espèces selon leurs aptitudes dans l'environnement biotique et abiotique considéré [@Molino2001], et stochastiques  d'autre part relevant  de la théorie neutre et impliquant les contraintes historiques et de limitation de dispersion ou de croissance [@Hubbell2001].
