...
A partir des trajectoires de diversité et de composition des parcelles
de Paracou nous avons pu expliciter la réponse des forêts tropicales aux
perturbations et identifier les processus écologiques sous-jacents. Ce
travail nous a permis de discuter des pratiques d'exploitation et de
conservation des forêts tropicales et de proposer différents axes de
recherches pour mieux appréhender leur devenir dans le contexte des
changements actuels .

L'étude de la biodiversité est souvent limitée dans le temps, dans
l'espace et dans la précision des inventaires forestiers et des bases de
données fonctionnelles, du fait de leur coût financier et humain. Le
premier travail de cette thèse a été la conception d'un estimateur de
diversité intégrant les incertitudes inhérentes aux inventaires
forestiers et aux bases de données fonctionnelles pour pallier leur
imprécision. A l'aide de cet estimateur nous avons ensuite étudié les
trajectoires des communautés au cours de 30 ans suivant un gradient de
perturbation en considérant la composition, la richesse, l'équitabilité
et la redondance des communautés en espèces (diversité taxonomique), et
en termes de traits fonctionnels (diversité fonctionnelle). Nous avons
ensuite spécifiquement examiné les trajectoires de diversité des arbres
recrutés, clarifiant les étapes de la succession après perturbation. Ces
trajectoires ont permis d'expliciter les processus écologiques
sous-jacents la réponse des communautés aux perturbations, le rôle de
l'intensité de perturbation et des caractéristiques de la communauté
initiale, et de clarifier la résilience la taxonomiques et fonctionnelle
des communautés. Ces résultats nous ont permis de discuter d'une part de
la possibilité et les critères d'évaluation d'une exploitation durable
et d'autre part des perspectives pour modéliser la diversité des
communautés et ainsi formaliser et prédire la réponse de sforêts
tropciales aux perturbations.

\section{La diversité des communautés, entre déterminisme et
stochasticité}\label{la-diversite-des-communautes-entre-determinisme-et-stochasticite}
...
Spécifiquement en forêt tropicale, le débat porte sur la prépondérance
de processus stochastiques supposée par la théorie neutre qui prédit un
assemblage aléatoire des espèces par rapport à des processus
...
intermédiaires. La prépondérance de processus stochastique implique que
l'assemblage des communautés varie de façon aléatoire suivant des
...
dispersion). La prépondérance de processus déterministes à l'inverse
suppose la convergence des communautés vers la composition et la
diversité d'avant perturbation, déterminées par les caractéristiques
environnementales. Les deux théories neutres et déterministes ne se sont
pas incompatibles et se sont montrées pertinentes dans différents cas de
figure. \autocite{Chave2004} propose une théorie intégrative expliquant
la diversité et la composition des communautés par la combinaison
variable dans le temps et l'espace des processus stochastiques et
déterministes.

\subsection{Une succession fonctionnelle
déterministe}\label{une-succession-fonctionnelle-deterministe}

La réponse des communautés dépend des changements biotiques et
abiotiques qui accélèrent la croissance des arbres et augmentent le
nombre de recrutés. Après perturbation l'émergence de processus
déterministes de sélection des espèces définit les trajectoires de
diversité et de composition fonctionnelle des communautés, et par
extension leur fonctionnement \autocites{Violle2007b}{Baraloto2012a}. La
perturbation, matérialisée par la mortalité d'une partie de la
...
Si le taux de mortalité est plus élevé après perturbation, la
composition et la diversité des arbres survivants a montré refléter
celles d'avant perturbation \autocite{Herault2018}. Les changements de
diversité et de composition fonctionnelle des communautés relèvent donc
du recrutement d'espèces dont la stratégie fonctionnelle diffère des
traits moyens de la communauté.

Dans un premier temps les juvéniles déjà en place avant perturbation
réagissent aux changements environnementaux sans être soumis à des
processus de sélection et on suppose que leur recrutement ne modifie pas
le fonctionnement de l'écosystème \autocites{Denslow2000}{Herault2010}.
Dans un deuxième temps les arbres recrutés, issus de la germination des
graines de la banque du sol, sont soumis à des processus d'exclusion
compétitive basés sur leur stratégie d'acquisition de la lumière. Les
individus recrutés à ce moment, qui consituent l'essentiel du
recrutement après perturbation \autocite{Lawton1988}, correspondent
majoritairement à des espèces à croissance rapide, au détriment
d'espèces tolérantes à l'ombre inféodées aux forêts non perturbées. Ces
espèces pionnières sont peu diversifiées, mais leur dissimilarité par
rapport à la communauté d'avant perturbation augmente malgré tout la
diversité fonctionnelle. Au delà d'un seuil d'intensité de perturbation
(plus de 25\% de biomasse initiale perdue) correspond nous avons établi
que quelques espèces très pionnières dominaient largement cette seconde
phase de recrutement (par exemple \emph{Cecropia spp}, \emph{Pourouma
spp.} ou \emph{Vismia spp.}) \autocite{Guitet2018}. A ce moment, les
stratégies fonctionnelles très héliophiles deviennent dominantes et on
s'attend à d'importantes modifications du fonctionnement des
communautés. Ces stratégies ``acquisitives'' vis à vis des ressources du
milieu correspondent à des espèces à courte durée de vie et aux tissus
peu denses, impliquant un turnover rapide du carbone (peu stocké dans la
biomasse végétale) et des nutriments (rapidement dégradés dans la
litière) \autocite{Falster2011}. Ces espèces présentent également une
hauteur et un diamètre maximums faibles, ce qui amplifie les changements
de structure générés par les pertubations et modifie la valeur
économique du peuplement \autocite{Rutishauser2016}. Au cours du temps,
la croissance du premier pool de recrutés entraîne des modifications de
structure et de l'environnement abiotique de la communauté (fermeture de
la canopée, rétablissement de la compétition, etc.) et les espèces
pionnières sont moins favorisées par rapport aux espèces d'avant
perturbation \autocite{Denslow2000}. Le recrutement correspond ainsi
dans un troisième temps à la restauration des caractéristiques
fonctionnelles d'avant perturbation,déterminant une trajectoire cyclique
fonctionnelle cyclique. L'implication d'un pool unique de pionnières
rend la trajectoire après perturbation commune à toutes les communautés.
Malgré des modifications fonctionnelles plus importantes au delà du
seuil d'intensité, les trajectoires suivant les pertubations les plus
intenses rejoignent la trajectoire commune et la résilience
fonctionnelle des communautés n'est pas remise en cause.

\subsection{Les trajectoires taxonomiques: diversité déterminée et
composition
stochastique}\label{les-trajectoires-taxonomiques-diversite-determinee-et-composition-stochastique}

La nature et le déterminisme de l'impact des perturbations sur la
diversité taxonomique restent controversés en forêt tropicale
\autocite{Sheil2003}. Les trajectoires observées à Paracou, qui
correspondent à la réponse précise au cours du temps des communautés à
un gradient de perturbation déterminé, permettent d'éclairer cette
controverse. Les trajectoires de Paracou ont montré que en deça d'un
seuil d'intensité (environ 25\% de biomasse initiale perdue) un pool
d'espèces pionnières spécifiquement recrutées après perturbation
augmente la diversité des communautées initiales d'avant perturbation,
où elles étaient rares, mais n'y deviennent pas dominantes. La diversité
taxonomique est maximale à un stade intermédiaire de la succession,
lorsque les espèces ayant pu bénéficier de l'espace libéré par la
perturbation sont effectivement recrutées mais pas encore exclues par la
compétition suivant la croissance de la communauté. Conformément aux
hypothèses de \textcite{Connell1978} sur la théorie des perturbations
intermédiaires, un régime de perturbations régulières d'intensité
moyenne entraîne une diversité maximale quelque temps après
perturbation. Un tel régime entraîne de façon déterministe la
coexistence d'espèces pionnières, mobilisant efficacement les ressources
rendues disponibles par la perturbation, et d'espèces de succession
tardives (dont la diversité est maintenue malgré la perturbation), plus
compétitives et qui exclueront les pionnères par la suite
\autocite[\textcite{Guitet2018}]{Molino2001}.

Si la diversité taxonomique est déterminée par la perturbation, la
composition taxonomique des communautés en revanche relève de processus
aléatoires. Les trajectoires de composition taxonomique après
perturbation ont montré la divergence taxonomique des communautés et le
maintien de leurs différences initiales. Peu d'espèces non présentes
initialement s'installent après perturbation malgré l'espace libéré, une
limite qui vient probablement des limites de dispersion identifiées pour
beaucoup d'espèces de forêt tropicale \autocite{Svenning2005}. La
composition initiale des communautés détermine les trajectoires après
perturbation, les différeces de composition étant maintenues malgré le
renouvellement des espèces dans la communauté. Conformément à l'esprit
de la théorie neutre la composition taxonomique des communautés relève
donc de la contingence historique, \emph{i.e.} du hasard de l'arrivée et
de l'installation des espèces, plus que de processus de sélection
déterministes \autocite{Hubbell2001}.

Les communautés convergent donc dans l'espace fonctionnel, comme on l'a
vu, tandis qu'elles divergent dans l'espace taxonomique
\autocite{Fukami2005}. Cette dichotomie entre trajectoires de
composition taxonomique et fonctionnelle s'explique par la redondance
fonctionnelle élevée des forêts tropicales \autocite{Bellwood2006}.
Cette redondance fonctionnelle élevée indique que de nombreuses espèces
partagent les mêmes traits et stratégies fonctionnelles. Cela implique
d'une part que le fonctionnement et la réponse fonctionnelle aux
perturbations soit similaires entre communautés malgré leurs différences
de composition taxonomique, et d'autre part que l'impact fonctionnel des
perturbations soit atténué car le rôle d'une espèce disparue de la
communauté sera assuré par une espèce redondante \autocite{Carmona2016}.
Par ailleurs, une redondance fonctionnelle élevée implique une
compétition importante entre espèces redondantes, ce qui rend la
restauration taxonomique des communautés lente et dépendante du hasard
de recrutement des espèces. La population des espèces rares en
particulier, qui disparaissent de la communauté plus fréquemment après
perturbation du fait de leur effectif réduit, s'avère longue à
restaurer. Selon la principe de ``lottery recruitment'', les premières
espèces recrutées s'établiront dans la communauté tandis que celles, par
hasard, recrutées plus tard seront en compétition ave les premières et
s'établiront plus difficilement \autocite{Busing2002}. La restauration
de la composition taxonomique et de la redondance fonctionnelle
initiales est longue et difficile à anticiper. La redondance
fonctionnelle garantie la résilience des communautés et atténue l'impact
des perturbations sur le fonctionnement des écosystèmes, plusieurs
espèces pouvant assurer le même rôle, mais elle reste impactée plusieurs
décennies après pertubation. On s'attend à ce que la réponse des
communautés après de nouvelles pertubations soit assez différente, et
notamment à ce que le fonctionnement finisse par être modifié sur le
long terme et la redondance fonctionnelle n'est pas restaurée. La
restauration lente des espèces rares quand à elle accroît le risque de
voir certaines espèces disparaître localement, et de voir la richesse
...
L'impact de l'exploitation forestière sur le maintien de la biodiversité
demeure cependant controversé, spécifiquement sur le long terme.
L'adoption de l'exploitatoin sélective dans de nombreux pays rend
primordiale d'expliciter son impact sur la biodiversité des communautés,
et plus spécifiquement le rôle des différents paramètres de
l'exploitation tels que la densité d'exploitation, le diamètre minimal
de coupe, ou la durée des rotations.
...
écosystémiques \autocite{ITTO2005}. L'équilibre des écosystèmes et les
services qu'ils rendent dépendent largement des interactions entre
espèces et donc de leur composition et de leur diversité biologique
qu'il est primordial de maintenir à long terme \autocite{Begon2006}.
...
contexte de l'exploitation forestière, ceci implique des cycles de
rotation longs en comparaison de ce qui a pu être éprouvé et validé pour
d'autres bassins forestiers tropicaux, notamment en Afrique.

L'impact de l'exploitation sur la diversité et la composition des
communautés est complexe, et spécifiquement les changements de
composition taxonomique qui relèvent de processus aléatoires sont
difficiles à anticiper et peuvent n'être visibles qu'à long terme. Ces
changements peuvent cependant avoir des conséquences inattendues,
entraînant par exemple avec la disparition d'espèces clé pour la faune
ou la flore, ou un blocage de succession modifiant durablement
l'écosystème. Compte tenu de cette complexité, il est a mon sens tout
d'abord recommandé d'une part de garder à l'esprit de telles
possibilités, d'autre part d'adopter un principe de précaution en
favorisant par défaut la conservation des communautés, et enfin de
poursuivre la recherche de voies d'amélioration de la gestion forestière
et de nouveaux moyens (de mesure, de surveillance ou de modélisation)
pour appréhender la réponse des écosystèmes. Dans cette perspective, les
trajectoires étudiées ici ont lontré le rôle central de la redondance
fonctionnelle pour appréhender la restauration de la résilience et de la
composition taxonomique des communautés. Une restauration inachevée de
la redondance fonctionnelle signifie en effet à terme la disparition
locale des espèces rares et la diminution de la résilience des
écosystèmes. Nous proposons en conséquence d'adopter la redondance
fonctionnelle de la communauté (dans l'espace fonctionnel initial avant
perturbation) comme critère de restauration de l'écosystème, en plus des
indicateurs fonctionnels (\emph{i.e.} la hauteur maximale, la vitesse de
croissance ou la biomasse aérienne totale, etc).
...
communautés ont montré un rôle primoridal pour appréhender le
fonctionnement et le maintien des écosystèmes. Ces conclusions
concernent des mesures fonctionnelles basées sur des traits fonctionnels
clés, représentatifs de l'écologie, de la croissance et dans une
certaine mesure des performances de reproduction des espèces. Comme tout
jeu de traits fonctionnel, ce choix n'est cependant pas exhaustif du
