...
Hypothesis, IDH} en anglais) qui prédit la prépondérance des processus
déterministes d'exclusion compétitive et de filtrage des espèces, et une
diversité maximale pour un régime moyen de perturbations
\autocite{Molino2001}. Selon la théorie des perturbations intermédiaires
des perturbations qui modifierait régulièrement mais non drastiquement
les conditions environnementales biotiques (interactions entre
individus) et abiotiques (ensoleillement, température, flux d'eau et de
matière) permettrait à diverses espèces de s'installer lorsque les
conditions leurs sont favorables \autocites{Kariuki2006a}{Berry2008a}. A
l'inverse la théorie neutre suppose que les espèces sont équivalentes et
que leur abondance ne dépend pas de leurs caractéritiques écologiques et
