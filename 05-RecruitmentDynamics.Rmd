...
Bien que résilientes les caractéristiques taxonomiques et fonctionnelles du recrutement se sont montrée impactées sur plusieurs décennies, incitant à la prudence quantd au maintien des caractéristiques initiales.
...
Ariane MIRABEL ^1^ ^\*^, Eric Marcon ^1^, Bruno Hérault ^2^ \newline
